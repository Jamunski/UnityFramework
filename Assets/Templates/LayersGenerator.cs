...
namespace Assets.Templates
{
	...
	for( int i = 0; i < m_UnityLayers.Length; i++ )
	{

            this.Write("\tpublic const int ");
            this.Write(this.ToStringHelper.ToStringWithCulture(m_UnityLayers[i].Replace(" ", "")));
            this.Write(" = ");
...
private string[] _m_UnityLayersField;

/// <summary>
/// Access the m_UnityLayers parameter of the template.
/// </summary>
private string[] m_UnityLayers
{
    get
    {
        return this._m_UnityLayersField;
    }
}
...
bool m_UnityLayersValueAcquired = false;
if (this.Session.ContainsKey("m_UnityLayers"))
{
    this._m_UnityLayersField = ((string[])(this.Session["m_UnityLayers"]));
    m_UnityLayersValueAcquired = true;
}
if ((m_UnityLayersValueAcquired == false))
{
    object data = global::System.Runtime.Remoting.Messaging.CallContext.LogicalGetData("m_UnityLayers");
    if ((data != null))
    {
        this._m_UnityLayersField = ((string[])(data));
    }
}
